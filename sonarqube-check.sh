...
PROJECT_KEY="code"
BRANCH="main"
API_URL="http://172.18.255.200/sonarqube/api/ce/component?component=${PROJECT_KEY}&branch=${BRANCH}"
TOKEN="squ_d918cdb2cc2143427334155c177dc15d930ce10e"
